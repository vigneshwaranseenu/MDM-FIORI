		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commdmzmissint-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commdmzmissint-display": {
								"semanticObject": "commdmzmissint",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mdm.zmissint",
									"url": sap.ui.require.toUrl("com/mdm/zmissint")
								}
							}
						}
					}

sap.ui.jsfragment("com.mdm.zmissint.view.fragments.ValidationFail", {
    createContent: function (oController) {
        return new sap.m.Page(this.createId("homepage1"), {
            showHeader: false,
            content: [
                new ExcelGrid("grid1", {
                    data: "{oValidationFailModel>/validationFailData}",  //binding the model
                    options: {
            ...
            headerContent: new sap.m.ObjectStatus(this.createId("objectStatus1"), {
                text: "OK",
                state: "Success",
                inverted: true,
                visible: "{= !!${/visibility}}"
